...
class ShadowFetch
  ...
  def followRedirect=(follow)
    debug "follow redirects: #{follow}"
...
#    elsif @data !~ /\<\/html\>\s*$/
#      if (@url =~ /wherigo\.com/ and @url !~ /download.aspx/)
